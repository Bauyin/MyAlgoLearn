...
- (void)navigationController:(UINavigationController *)navigationController willShowViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    ...
    {
        NSString *bundlePath = [[NSBundle mainBundle] pathForResource:@"KooCategoryBundle.bundle" ofType:nil];
        NSBundle *bundle = [NSBundle bundleWithPath:bundlePath];
        NSString *loadImagePath = [bundle pathForResource:@"category_back_dark" ofType:@"png"];
        UIImage *loadImage = [[UIImage alloc] initWithContentsOfFile:loadImagePath];
